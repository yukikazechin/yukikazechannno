...
# 输入启动脚本
echo "sudo docker run -d --name onebot-docker0 -p 3002:3002 -p 6099:6099 -p 3001:3001 -v ${PWD}/LiteLoader:/opt/QQ/resources/app/LiteLoader mlikiowa/llonebot-docker" > start.sh
